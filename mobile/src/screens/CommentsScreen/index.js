...
import { View, Text, StyleSheet, ActivityIndicator, FlatList, TextInput, Image, KeyboardAvoidingView, Alert } from 'react-native';
...
class CommentsScreen extends PureComponent {
  ...
  _onSubmit = () => {
  //  Alert.alert('Thanks for your comment', this.state.comment);
